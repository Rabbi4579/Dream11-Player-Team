  ...
  return (
    <div className="bg-black h-[545px]">
      ...
      >
          ...
          <button className="bg-[#E7FE29] py-2 px-4 rounded-md mt-3 text-[16px] text-[#131313] font-bold ring-1 ring-[#E7FE29] ring-offset-4 ring-offset-black">Claim Free Credit</button>
