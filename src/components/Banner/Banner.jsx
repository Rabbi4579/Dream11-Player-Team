  ...
  return (
    <div className="bg-black h-[545px] mb-20">
      ...
      >
          ...
          <button onClick={handleCoin} className="bg-[#E7FE29] py-2 px-4 rounded-md mt-3 text-[16px] text-[#131313] font-bold ring-1 ring-[#E7FE29] ring-offset-4 ring-offset-black">Claim Free Credit</button>
